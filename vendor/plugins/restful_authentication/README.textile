...
* Account   roval / disabling by admin
...
* "http://rails_security.lighthouse  .com/projects/15332-restful_authentication/overview":http://rails_security.lighthouse  .com/projects/15332-restful_authentication/overview
...
**IMPORTANT FOR RAILS > 2.1 USERS** To avoid a @NameError@ exception ("lighthouse tracker ticket":http://rails_security.lighthouse  .com/projects/15332-restful_authentication/tickets/2-not-a-valid-constant-name-errors#ticket-2-2), check out the code to have an _underscore_ and not _dash_ in its name:
