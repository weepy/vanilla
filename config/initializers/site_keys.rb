...
REST_AUTH_SITE_KEY         = '5dbd40511bfc1ef7c9b0a21010a36f8728fa3efa'
  
# Repeated   lications of the hash make brute force (even with a compromised
...
# times harder, while reducing an    that otherwise serves 100 reqs/s to 78 signin
# reqs/s, an    that does 10reqs/s to 9.7 reqs/s
# 
# More:
